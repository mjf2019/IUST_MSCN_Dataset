...
do
   ...
   rm argus/smtp_filter_mirror_${i}.argus
   argus -r pcap/smtp_filter_mirror_${i}.pcapng -w argus/smtp_filter_mirror_${i}.argus
...
do
   ...
   do
      ...
      rm flow/${str}/smtp_${str}_mirror_${i}.flow
      ra -F /home/argus/ra_conf/ra_${str}_based.conf -r argus/smtp_filter_mirror_${i}.argus -n -Z b > flow/${str}/smtp_${str}_mirror_${i}.flow
