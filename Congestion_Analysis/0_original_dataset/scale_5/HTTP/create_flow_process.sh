...
do
   ...
   rm argus/http_filter_mirror_${i}.argus
   argus -r pcap/http_filter_mirror_${i}.pcapng -w argus/http_filter_mirror_${i}.argus
...
do
   ...
   do
      ...
      rm flow/${str}/http_${str}_mirror_${i}.flow
      ra -F /home/argus/ra_conf/ra_${str}_based.conf -r argus/http_filter_mirror_${i}.argus -n -Z b > flow/${str}/http_${str}_mirror_${i}.flow
