...
do
   ...
   rm argus/video_filter_mirror_${i}.argus
   argus -r pcap/video_filter_mirror_${i}.pcapng -w argus/video_filter_mirror_${i}.argus
...
do
   ...
   do
      ...
      rm flow/${str}/video_${str}_mirror_${i}.flow
      ra -F /home/argus/ra_conf/ra_${str}_based.conf -r argus/video_filter_mirror_${i}.argus -n -Z b > flow/${str}/video_${str}_mirror_${i}.flow
